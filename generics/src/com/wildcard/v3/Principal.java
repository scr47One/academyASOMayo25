...
public class Principal {
	...
	public static void main(String[] args) {
		...
		List<? super Figura> lista;
		
		lista = listaObject;
		//lista.add(new Object());
		lista.add(new Figura(3.0));
		lista.add(new Circulo(3.0));
//		lista = listaString;
//		lista = listaCirculo;
//		lista = listaCuadrado;
//		lista = listaTriangulo;
	...
	static void imprimir(List<? super Figura> lista) {
		//lista.add(new String("Hola")); //NO SE PUEDE
